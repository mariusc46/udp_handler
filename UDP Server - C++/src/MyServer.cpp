...
void udp_listener::MyServerClass::receiveFrames()
{
    ...
    // std::cout << " Waiting for incoming UDP frame.. \n";
...
void udp_listener::MyServerClass::initServer(const std::string ip, const int port)
{
    myUdpServer = new udp_client_server::udp_server(ip, port);
}